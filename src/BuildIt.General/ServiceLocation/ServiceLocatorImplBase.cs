...
namespace BuildIt.ServiceLocation
{
    ...
    public abstract class ServiceLocatorImplBase : IServiceLocator
    {
        ...
        /// <exception cref="BuildIt.ServiceLocation.ActivationException">if there is an error in resolving the service instance.</exception>
        ...
        /// <exception cref="BuildIt.ServiceLocation.ActivationException">if there is an error resolving
        ...
        public virtual object GetInstance(Type serviceType, string key)
        {
            ...
            {
                throw new BuildIt.ServiceLocation.ActivationException(
        ...
        /// </summary>
        /// <param name="serviceType">Type of object requested.</param>
        /// <exception cref="BuildIt.ServiceLocation.ActivationException">if there is are errors resolving
        /// the service instance.</exception>
        ...
        /// <summary>
        /// Format the exception message for use in an <see cref="BuildIt.ServiceLocation.ActivationException"/>
        ...
        {
            return string.Format(CultureInfo.CurrentUICulture, Resources.Resources.ActivationExceptionMessage, serviceType.Name, key);
        }
        ...
        {
            return string.Format(CultureInfo.CurrentUICulture, Resources.Resources.ActivateAllExceptionMessage, serviceType.Name);
        }
    }
}
