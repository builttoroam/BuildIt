...
namespace BuildIt.Lifecycle.States.ViewModel
{
    ...
    public class BaseStateManagerViewModelWithCompletionData<TCompletion, TData>
        : BaseStateManagerViewModelWithCompletion<TCompletion>,
        ...
        where TCompletion : struct
    {
        ...
        protected void OnCompleteWithData(TCompletion completion, TData data)
        {
            var completionArgs =
