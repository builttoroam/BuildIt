...
using BuildIt.Media.Uno.WinUI.Listeners;
using Java.IO;
using Java.Lang;
using Java.Util;
...
namespace BuildIt.Media.Uno.WinUI
{
    public partial class CameraPreview
    {
        ...
        private void RequestCameraPermission()
        {
            ...
            //else
            //{
            ActivityCompat.RequestPermissions(((Android.App.Activity)ContextHelper.Current), new string[] { Manifest.Permission.Camera },
