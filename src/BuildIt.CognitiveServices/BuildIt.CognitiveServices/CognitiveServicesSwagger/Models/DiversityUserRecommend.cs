...
namespace BuildIt.CognitiveServices.Models
{
    ...
    public partial class DiversityUserRecommend
    {
        /// <summary>
        /// Initializes a new instance of the DiversityUserRecommend class.
        /// </summary>
        public DiversityUserRecommend() { }
        ...
        /// cases.</param>
        public DiversityUserRecommend(System.Collections.Generic.IList<PercentileBucket> percentileBuckets = default(System.Collections.Generic.IList<PercentileBucket>), int? totalItemsRecommended = default(int?), int? uniqueItemsRecommended = default(int?), int? uniqueItemsInTrainSet = default(int?), string error = default(string))
        {
