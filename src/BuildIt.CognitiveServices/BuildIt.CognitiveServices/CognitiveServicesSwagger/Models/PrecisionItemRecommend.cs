...
namespace BuildIt.CognitiveServices.Models
{
    ...
    public partial class PrecisionItemRecommend
    {
        /// <summary>
        /// Initializes a new instance of the PrecisionItemRecommend class.
        /// </summary>
        public PrecisionItemRecommend() { }
        ...
        /// cases.</param>
        public PrecisionItemRecommend(System.Collections.Generic.IList<PrecisionMetric> precisionMetrics = default(System.Collections.Generic.IList<PrecisionMetric>), string error = default(string))
        {
