...
namespace BuildIt.States.Interfaces
{
    ...
    {
        /// <summary>
        /// Method to initialize the data entity
        /// </summary>
        Func<TData, Task> Initialise { get; set; }

        /// <summary>
        /// Method to invoke when about to change from the data entity
        /// </summary>
        Func<TData, CancelEventArgs, Task> AboutToChangeFrom { get; set; }

        /// <summary>
        /// Method to invoke when changing from the data entity (eg leaving view model)
        /// </summary>
        Func<TData, Task> ChangingFrom { get; set; }

        /// <summary>
        /// Method to invoke when change to the data entity (eg arriving at view model)
        /// </summary>
        Func<TData, Task> ChangedTo { get; set; }

        /// <summary>
        /// Method to invoke when change to a data entity with data (eg data to be passed into view model)
        /// </summary>
