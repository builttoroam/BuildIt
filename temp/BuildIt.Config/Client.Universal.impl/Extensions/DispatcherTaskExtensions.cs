...
namespace Client.Universal.impl.Extensions
{
    ...
    {
        public static async Task<T> RunTaskAsync<T>(this CoreDispatcher dispatcher, System.Func<Task<T>> func, CoreDispatcherPriority priority = CoreDispatcherPriority.Normal)
        {
