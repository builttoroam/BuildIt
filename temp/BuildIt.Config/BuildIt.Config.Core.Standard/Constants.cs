namespace BuildIt.Config.Core.Standard
{
    public class Constants
    {
        ...
        public const string AppConfigurationMinVersionKey = "App_VersionInfo_MinimumRequiredVersion";
        ...
        public const string AppConfigurationRecommVersionKey = "App_VersionInfo_RecommendedVersion";
