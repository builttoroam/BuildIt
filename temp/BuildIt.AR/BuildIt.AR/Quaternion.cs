...
namespace BuildIt.AR
{
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public static Quaternion Slerp(Quaternion quaternion1, Quaternion quaternion2, float amount)
        {
            ...
            {
                var num5 = (float)Math.Acos((double)num4);
                var num6 = (float)(1.0 / Math.Sin((double)num5));
        ...
        {
            var num = 1f / ((float)Math.Sqrt((X * X) + (Y * Y) + (Z * Z) + (W * W)));
            X *= num;
            Y *= num;
            Z *= num;
            W *= num;
        ...
        {
            Quaternion result;
            var num = 1f / ((float)Math.Sqrt((quaternion.X * quaternion.X) + (quaternion.Y * quaternion.Y) + (quaternion.Z * quaternion.Z) + (quaternion.W * quaternion.W)));
            result.X = quaternion.X * num;
            result.Y = quaternion.Y * num;
            result.Z = quaternion.Z * num;
            result.W = quaternion.W * num;
